    ...
    public ServletContextInitializer initializer() {
        return new ServletContextInitializer() {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "me.whiteship");
                servletContext.setInitParameter("tapestry.development-modules", "me.whiteship.services.DevelopmentModule");
